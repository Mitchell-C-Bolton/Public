...
Name: Mitchell Bolton, Trevor Burch, Jasper Cordova
Date: 11/03/2022
Changes:
- Error fix for Lenel thing
*/
; prettier-ignore
ScriptVersion = 3.03
...
^0::
^Numpad0::
#IfWinActive, BAC-RDS.CORP.AMAZON.COM
^0::
^Numpad0::
#IfWinActive, GS-TS-BR-NA.CORP.AMAZON.COM
^0::
^Numpad0::
#IfWinActive, gs-app-ue1d022p.ant.amazon.com
^0::
^Numpad0::
...
Gui, AA: Add, Text,x126 y7 BackgroundTrans, V3.03
