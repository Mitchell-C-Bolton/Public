...
Date: 03/14/2022
Changes: 
- Alarm Cause > "Select Cause" first item - required
- Alarm Cause > Add > "Emergency Event"
	○ Optional
		§ Pop up box - Case #
- Planned work - Optional
	○ Pop up
		§ Limit pop up to SIM T
- Device issue - Optional
	○ Pop up
		§ Limit pop up to SIM T
- Change all D3 > "Case #"
- Implement an "update required " feature
- Change TT to SIM T
...
SetWorkingDir, \\ant\DEPT\ACS-back-up\Second-Shift\Bolton(DO-NOT-DELETE)

FileRead, CurrentVersion, %A_WorkingDir%\AAVersion.txt
...
Gui, Add, Text,x126 y7 BackgroundTrans, V2.04
...
Gui, Add, DropDownList, W137 vCause, Select...||Undetermined|Human Error|Human Error by IT|Human Error by Security|Emergency Event|Breach/Forced Entry|Key Override|Unattended Escort|Technical Issue|Device Issue|Programming Issue|Un-Notified Work|Pre-Notified Work|Audit|Testing
...
{
Gui, Add, Text, BackgroundTrans, SIM T#:
Gui, Add, Edit, w130 vDeviceTT
GuiControl, focus, DeviceIssueTT
}
...
Gui, Add, Text, BackgroundTrans, SIM T#:
Gui, Add, Edit, w130 vDeviceTT
GuiControl, focus, PreNotifiedWorkTT
}

If (Cause = "Breach/Forced Entry")
{
Gui, Add, Text,BackgroundTrans, Case #:
Gui, Add, Edit, w130 vDeviceTT
GuiControl, focus, BreachedForcedEntryTT
}
...
Gui, Add, Text,BackgroundTrans, Case #:
Gui, Add, Edit, w130 vDeviceTT
GuiControl, focus, EmergencyEventTT
}
...
Gui, Add, DropDownList, vCameraSLAType W55, SIM T||MCM|SIM|Case #
...
Gui, Add, DropDownList, vLenelOutageType W55, SIM T||MCM|SIM|Case #
...
Gui, Add, DropDownList, vAlarmLatencyType W55, SIM T||MCM|SIM|Case #
...
Gui, Add, DropDownList, vTriageType W55, SIM T||MCM|SIM|Case #
...
Gui, Add, DropDownList, vLocationType W55, SIM T||MCM|SIM|Case #
...
Gui, Add, DropDownList, x10 y10 vUCTCWorkType W55, SIM T||MCM|SIM|Case #
