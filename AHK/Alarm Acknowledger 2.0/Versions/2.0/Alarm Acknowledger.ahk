...
FileDelete,  C:\ProgramData\AlarmAcknowledger\Resources.zip

;---------------------------------------------------------------------------------------- Hide Resources

FileSetAttrib, +RAH, C:\ProgramData\AlarmAcknowledger
FileSetAttrib, +RAH, C:\ProgramData\AlarmAcknowledger\*.*
FileSetAttrib, +RAH, C:\ProgramData\AlarmAcknowledger\Resources
FileSetAttrib, +RAH, C:\ProgramData\AlarmAcknowledger\Resources\*.*
...
Gui, Add, Text,x130 y7 BackgroundTrans, V2.0
...
else if (CameraSLA = 1  or LocationSLA = 1 or PWorkMSLA = 1 or UPWorkMSLA)
{
	TF =; False
}
else
