...
Gui, Add, DropDownList, W130 vCause, Improper Device Use||Policy Violation|Evacuation|Device Malfunction|Planned Work|Unknown
Gui, Add, Checkbox, vCCTV, CCTV Clear
Gui, Add, Checkbox, vDay1, Day 0
...
Gui, Add, Button,x110 y228, !
Gui, Add, Button,x130 y228, ?
...
Clipboard =
(
ROS;%ResponderType%;%CCTV%%Day1%;%Cause%%Confirmed%%DTTText%%DeviceTT%%STTText%%SLATT%%Scanned%
)
