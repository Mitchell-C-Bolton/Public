...
Gui, Add, Button,x110 y187, !
Gui, Add, Button,x130 y187, ?
...
Clipboard =
(
Site Safe and Secure; %ResponderType%; %CCTV%; %Cause%%Confirmed%%DTTText%%DeviceTT%%STTText%%SLATT%
)
...
Gui, Font, norm
Gui, Add, Text,X30 Y390,- Occasionally Lenel will freeze on the "Acknowledge Selected Alarms" screen. This issue has been fixed.
