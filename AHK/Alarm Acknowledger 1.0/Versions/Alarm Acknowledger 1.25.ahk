...
InputBox, ResponderType, Responder Type,,,190,100
if ErrorLevel = 1
{
return
}
...
{
Device = Device TT #
InputBox, DeviceTT, Device TT,,,190,100
if ErrorLevel = 1
{
return
}
...
{
Tier = SLA TT #
InputBox, SLATTNum, SLA TT Number,,,190,100
if ErrorLevel = 1
{
return
}
...
Clipboard =
(
%ResponderType%; %CCTV%; %Cause%; %Device%%DeviceTT% %Tier%%SLATTNum%
)
