...
Scanned =; The responder stated they did not scan their badge at the security device
...
Clipboard =
(
Site Safe and Secure; %ResponderType%; %CCTV%; %Cause%%Confirmed%%DTTText%%DeviceTT%%STTText%%SLATT%%Scanned%
)
...
Gui, Add, Button, W102, &Badge Scanned
